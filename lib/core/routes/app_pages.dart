...
import '../../features/lessons/views/lesson_view.dart';
import '../../features/home/home_view.dart';
import '../../features/students/views/students_view.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(name: AppRoutes.MyHalaqah, page: () => StudentsView()),
    GetPage(name: AppRoutes.home, page: () => HomeView()),
    GetPage(name: AppRoutes.homemain, page: () => LessonView()),
